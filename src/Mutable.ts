...
const case4: Mutable<typeof objB> = { age: 20, name: 'Tuong', data: { anotherProperty: false, id: '123' } };
// Result: { age: 20, name: 'Tuong', data: { readonly id: "123"; readonly anotherProperty: false; }}


const a = [1, [2, 3, [4]]] as const;
const b = [1, [2, [3, [4]]]] as const;

export type DeepMutable<T> = { -readonly [P in keyof T]: DeepMutable<T[P]> }; 

const caseDeep1: DeepMutable<typeof a> = [1, [2, 3, [4]]]; // Result: [1, [2, 3, [4]]]
const caseDeep2: DeepMutable<typeof b> = [1, [2, [3, [4]]]] // Result: [1, [2, [3, [4]]]]