...
function takeSomeTypeOnlyWithExclusive<T extends SomeType>(x: ExclusiveObject<SomeType, T>) { return x }
function takeSomeTypeOnlyWithoutExclusive(x: SomeType) { return x };
const x = { prop: 'a' };
